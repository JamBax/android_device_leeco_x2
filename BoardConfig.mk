...
# Kernel
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 sched_enable_power_aware=1 sched_enable_power_hmp=1 androidboot.console=ttyHSL0 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff androidboot.selinux=permissive log_buf_len=4M
